export const tests = [
  ...
  },
  {
    ...
    message: '<code>insertionSort</code> should not use the built in <code>Array.sort()</code> method'
  },
  {
    expression: `
      (() => {
    ...
    message: '<code>insertionSort</code> should sort arrays from least to greatest'
  }
];
