export const tests = [
  ...
  },
  {
    ...
    message: '<code>mergeSort</code> should not use the built in <code>Array.sort()</code> method'
  },
  {
    expression: `
      (() => {
    ...
    message: '<code>mergeSort</code> should sort arrays from least to greatest'
  }
]
