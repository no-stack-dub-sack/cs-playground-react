export const tests = [
  ...
  },
  {
    ...
    message: '<code>bubbleSort</code> should not use the built in <code>Array.sort()</code> method'
  },
  {
    expression: `
      (() => {
    ...
    message: '<code>bubbleSort</code> should sort arrays from least to greatest'
  }
];
