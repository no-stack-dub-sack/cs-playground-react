// @flow
import { dragHorizontal, dragVertical } from '../actions/panes'

import type { OnDrag } from '../types/Actions'
import { store } from '../index'

export const onDragHorizontal: OnDrag = (el, pageX, startX, pageY, startY, resize) => {
  resize.skipX = true
  ...
  store.dispatch(dragHorizontal(cur, right))
}

export const onDragVertical: OnDrag = (el, pageX, startX, pageY, startY, resize) => {
  resize.skipY = true
  ...
  store.dispatch(dragVertical(cur, bottom))
}
